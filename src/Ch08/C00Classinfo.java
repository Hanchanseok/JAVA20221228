...
public class C00Classinfo {
	...
	//컴퓨터
	//속성 : CPUSpec, RAMSpec, DISKSpeck,...
	//기능 : 정보입력하기, 정보검색하기, 프로그램실행하기, 계산하기
	
	
	//4 클래스란?(객체를 생성하기 위한 선언된 자료형)
	//동일한 종류의 개체를 구현하기 위해 객체의 속성/기능을 미리 선언한 자료형
	...
	//3) 메서드(클래스)영역	: 공유 메모리 영역(생성자메서드,일반메서드,static메서드,static,변수)
