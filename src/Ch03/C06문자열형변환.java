...
//		System.out.println(',' + '!');					//77이 나오는 이유: 정수형으로 변환되기 때문에
//		System.out.println((int)'!');					//33
...
//		int n2 = Integer.parseInt("20");	//문자열 20이 숫자로 바뀐다.
...
//		System.out.println(n5+n6);
		...
		System.out.println(value1+ "" + value2);	//문자열로 처리
